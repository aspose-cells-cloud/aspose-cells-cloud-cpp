...
cmake --build ./build --config Debug --target aspose_cells_cloud_test || goto end
cmake --build ./build --config Release --target aspose_cells_cloud_test || goto end

REM Copy artifacts
mkdir .\build\artifacts
Xcopy /E /I .\build\aspose_cells_cloud_sdk\Debug .\build\artifacts\lib\Debug
Xcopy /E /I .\build\aspose_cells_cloud_sdk\Release .\build\artifacts\lib\Release
